...
\setmymonth{July}                  % Month degree is granted
...
\begin{abstract}
	...
	This model uses a node embedding technique that extracts node embeddings (knowledge of nodes) from the known links' weights (relations between nodes) and 
...
\cite{al2006link}, or more specifically link existence prediction, which is to predict the existence of a link.
