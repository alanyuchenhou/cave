...
\subsection{Model: fully connected neural net}
...
\begin{figure}[h]
	...
	1700 movies and 1000 users with node vector size 64: The d in the bracket 
	refers to dimension, the 
	layer's size (number of units in the layer). The text before the bracket 
	refers to the activation function of the units in the layer(except for 
	one-hot, which refers to the activations themselves).
