...
\pdfinfo{
	/Title (Collaborative Rating Prediction with Deep learning)
	/Author (Author 1, Author 2)
	/Keywords (deep learning, neural net, recommendation, rating, prediction)
}
...
without any domain knowledge \citeauthor{mikolov2013efficient}.
...
evaluation of the baseline solutions \citeauthor{polatidis2016multi} on four 
datasets 
