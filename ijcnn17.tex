...
\begin{figure*}[!htb]
	...
	\node (linear1) [io, below of=relu3, xshift=-3cm] {node vector};
	\node (linear2) [io, below of=relu3, xshift=3cm] {node vector};
	\node (oneHot1) [startstop, below of=linear1] {mapping table};
	\node (oneHot2) [startstop, below of=linear2] {mapping table};
