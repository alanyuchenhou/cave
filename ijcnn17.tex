...
\subsection{Model R}
We design he model in the estimator as a fully connected neural net which we call Model R (R as in "relation"), shown in Figure \ref{fig:model}.
We have considered a convolutional neural net as an alternative,
but there is not any spacial property in the input node vectors
...
For example, handle graphs with node attributes.
...
A social network can have large volume of links collected continuously by a
distributed system.
