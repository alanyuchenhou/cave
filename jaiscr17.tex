...
\begin{document}
\title{Link Weight Prediction with Deep Learning}
\author{
	name\\
	address1 \\
	address2 \\
...
A very recent approach is node2vec \cite{grover2016node2vec},
...
and node2vec \cite{grover2016node2vec} use the same skip-gram 
...
\begin{figure*}[!htb]\label{fig:errors}\centering
